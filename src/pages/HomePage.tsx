    ...
    <div className="bg-[#F5F5F5]">
      ...
      <div className="flex flex-col px-12 pt-5">
        ...
        <div className="flex flex-col justify-center mt-3">
          <h2 className="flex items-center font-bold text-justify max-[380px]:hidden">
            Find a good restaurant around you
          </h2>
          <h3 className="flex items-center font-bold text-justify min-[380px]:hidden">
            Find a good restaurant around you
          </h3>
        </div>
        <RestaurantSearchBar />
